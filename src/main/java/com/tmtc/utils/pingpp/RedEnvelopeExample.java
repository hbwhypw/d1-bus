 ...
 * 
 * openId 是发送红包的对象在公共平台下的openId ,获得 openId
 * 的方法可以参考微信文档：http://mp.weixin.qq.com/wiki/17/c0f37d5704f0b64713d5d2c37b468d75.
 * html
 * 
 */
public class RedEnvelopeExample {
	 ...
	 * 创建红包
	 * 
	 * 创建红包需要传递一个 map 到 RedEnvelope.create(redenvelope) map
	 * 里面的具体参数参考：https://pingxx.com/document/api#api-e-new
	 * 
	 * @return
	 */
	 ...
	 * 查询红包
	 * 
	 * 根据红包的 Id 查询红包。 参考文档：https://pingxx.com/document/api#api-e-inquiry
	 * 
	 * @param id
	 */
