...
/**
 * @author jiangxd
 * @version 1.0,2011-4-11 ����05:51:33
...
public class ExcelUtils {
	...
	public static Map<String, Object> beanToMap(Object obj,String dateFormat) {
		...
		try {
			...
			for (int i = 0; i < descriptors.length; i++) {
				String name = descriptors[i].getName();
				if (!StringUtils.equals(name, "class") && propertyUtilsBean.getNestedProperty(obj, name) != null) {
					if(propertyUtilsBean.getNestedProperty(obj, name) instanceof Date ){
						params.put(name, sdf.format((Date)propertyUtilsBean.getNestedProperty(obj, name)));
					} else if(propertyUtilsBean.getNestedProperty(obj, name) instanceof Byte) {
						params.put(name, ((Byte) propertyUtilsBean.getNestedProperty(obj, name)).intValue());
					} else if(propertyUtilsBean.getNestedProperty(obj, name) instanceof Double) {
     ...
     * @param list ��ݼ�
     * @param headMeta ��ͷ
     * @param fields �����Map�������飨ע�⣺˳��Ҫ���ͷ����˳���Ӧ������ݼ�ΪList<Object[]>����ò������Ϊnull��
     * @return TableData
     */
	...
	public static TableData createTableData(List list,TableHeaderMetaData headMeta,String[] fields){
        ...
        if(list != null && list.size()>0){
        	if(list.get(0).getClass().isArray()){//��������
                ...
                for (Object obj : list){
                	row = new TableDataRow(td);
                	Map<String, Object> map = (obj instanceof Map)?(Map<String, Object>)obj:beanToMap(obj,"yyyy-MM-dd HH:mm:ss");
	 ...
	 * @param headMeta ��ͷ
	 * @param fields ��Ҫ��ʾ���ֶ�
	 * @param formatFields ��ʽ���ֶΣ���һ��Ϊ
	 * @return TableData
	 */
	@SuppressWarnings("unchecked")
	public static TableData createTableData(List list,TableHeaderMetaData headMeta,String[] fields,String[] formatFields){
		TableData td = new TableData(headMeta);
		TableDataRow row = null;
		if(list != null && list.size()>0){
			if(list.get(0).getClass().isArray()){//��������
