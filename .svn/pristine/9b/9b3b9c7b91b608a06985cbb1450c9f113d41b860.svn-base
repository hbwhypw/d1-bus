...
public class CreditConsumeParams {
	...
	private String uid = "";
	private boolean waitAudit = false;// 是否等待审核， 如果返回true，表示此订单需要审核，审核通过后才会继续下去。
										// 如果返回false表示此订单无须审核，会直接继续兑换流程
	...
	public String toString() {
		return "CreditConsumeParams [appKey=" + appKey + ", timestamp=" + timestamp + ", credits=" + credits
				+ ", orderNum=" + orderNum + ", description=" + description + ", type=" + type + ", facePrice="
				+ facePrice + ", actualPrice=" + actualPrice + ", alipay=" + alipay + ", phone=" + phone + ", qq=" + qq
				+ ", uid=" + uid + ", waitAudit=" + waitAudit + ", ip=" + ip + ", params=" + params + ", transfer="
				+ transfer + "]";
	}
}
