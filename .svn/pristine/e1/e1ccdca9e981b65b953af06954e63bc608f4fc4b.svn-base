...
<table id="adminsDg" class="easyui-datagrid" data-options="url:'./../admins/query',rownumbers:true,toolbar:'#adminsDgTbar',
    ...
    <tr>
        ...
        <th data-options="field:'role_id',width:80">角色</th>
        <th data-options="field:'company_id',width:80">公司</th>
    ...
    <form id="adminsFm" class="fm" method="post" novalidate>
        <div class="fitem">
            ...
            <input id="username" name="username" class="easyui-validatebox" required="true"
            	data-options="validType: ['minLength[6]','maxLength[18]','specialChar']">
        </div>
        <div class="fitem">
            <label> 昵称： </label>
        ...
        <div class="fitem">
            <label> 角色： </label>
            <input id="role_id" name="role_id" class="easyui-combobox" data-options="
        ...
        <div class="fitem">
            <label> 公司： </label>
            <input id="company_id" name="company_id" class="easyui-combobox" data-options="
